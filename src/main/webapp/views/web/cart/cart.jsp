                            ...
                            <tr>
                                <td colspan="6">
                                    <div class="controls" style="float: right">
                                        <input type="submit" class="shopBtn" id="update-cart" name="update" value="CẬP NHẬT GIỎ HÀNG"/>
                                    </div>
                                </td>
                            </tr>
                            </tfoot>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><c:out value="${sessionScope.totalPrice}"/> VND</td>
                    </tr>
                    <tr>
                        <th>Tổng cộng:</th>
                        <td><strong><c:out value="${sessionScope.totalPrice}"/> VND</strong> </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <div class="controls" style="float: right">
